...
import { Container, Content, EmailData, EmailTitle, GoBackButton, Header, HeaderTitle, HeaderTop, Icon, NameData, NameTitle, PhotoButton, PhotoContainer, UserAvatar, UserEmailDetail, UserNameDetail } from "./styles";
